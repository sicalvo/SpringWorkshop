...
Look at the guidlines on Jenny Bryant's Happy Git with R website: https://happygitwithr.com/github-acct.html

Create your git account and make sure you write down your username and password.

Now in github.com, search for the repository here: https://github.com/joan-combs-durso/SpringWorkshop
and havd it ready. It's okay to go ahead and double click on the HTML file called intro-r.html and follow along.  
